...
export class GameCard {
    ...
    private renderBadges(parent: HTMLElement): void {
        ...
        if (this.game.tags?.includes('new')) {
            this.renderNewBadge(getGroup('top-right'));
        }
    }
    ...
    private renderNewBadge(parent: HTMLElement): void {
        const badge = parent.createDiv({ cls: 'lorebase-card-new-badge' });
        badge.appendChild(this.createSvgIcon(
